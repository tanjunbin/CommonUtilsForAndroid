...
public class StringUtils {
     ...
     * StringUtils.stripEnd("120.footer_ready_lesson", ".0")   = "12"
     * </pre>
     *
     * @param str        the String to remove characters from, may be null
     ...
     * @return
     */
    public static String addCharToSpacing(String sourceString, char chElemData) {
        String newString = "";
        for (int i = 0; i < sourceString.length(); i++) {
     ...
     * @return
     */
    public static String charSequenceSort(String str){
        char[] chars = new char[str.length()];
        for(int i=0;i<str.length();i++){
            chars[i] = CharUtils.toChar(str.charAt(i));
        }
